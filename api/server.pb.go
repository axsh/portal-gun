...
import fmt "fmt"
import math "math"
import driver "github.com/axsh/vpnhub/driver"
...
type CreateVpnRequest struct {
	VpnServer *driver.VpnServer `protobuf:"bytes,1,opt,name=vpn_server,json=vpnServer" json:"vpn_server,omitempty"`
}
...
func (m *CreateVpnRequest) GetVpnServer() *driver.VpnServer {
	if m != nil {
		return m.VpnServer
	}
	return nil
...
type RegisterNicRequest struct {
	Nic *driver.Nic `protobuf:"bytes,1,opt,name=nic" json:"nic,omitempty"`
}
...
func (m *RegisterNicRequest) GetNic() *driver.Nic {
	if m != nil {
		return m.Nic
	}
	return nil
...
func (m *DeregisterNicRequest) GetNic() *driver.Nic {
	if m != nil {
		return m.Nic
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
